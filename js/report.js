...
var _repActiveTab          = 'validation';  // 'validation' | 'scenarios' | 'stats' | 'log'
...
function _repBuildModalDOM() {
  ...
  host.innerHTML =
    '<div id="rep-modal">' +
      ...
      '</div>' +
      '<div class="rep-tabs">' +
        '<button class="rep-tab rep-tab-active" id="rep-tab-validation" onclick="_repShowTab(\'validation\')">&#9745; Validações</button>' +
      ...
      '</div>' +
      '<div class="rep-body">' +
        '<div id="rep-pane-validation" class="rep-pane rep-pane-active"></div>' +
...
function _repShowTab(tab) {
  _repActiveTab = tab;
  var tabs  = ['scenarios', 'validation', 'stats', 'log'];
